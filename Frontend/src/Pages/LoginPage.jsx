  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-base-300">
      ...
      <motion.div
        ...
        className="glass-panel w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row relative z-10"
      >
        {/* Left Side: Form */}
        <div className="w-full lg:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
          <div className="mb-8 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent tracking-wide">
                SocialTalk
              </span>
            </div>
            <h2 className="text-2xl font-semibold mt-4">Welcome Back!</h2>
            <p className="text-base text-base-content/60 mt-2">
              Sign in to reunite with your community.
            </p>
          </div>
