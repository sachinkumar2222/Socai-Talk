        ...
        <div className={`flex items-center w-full justify-between`}>
          <div className="pl-5">
            <Link to="/" className="flex items-center gap-2.5 lg:hidden">
              <EarthIcon className="size-9 text-primary sm:size-5 md:size-7" />
              <span className="text-3xl sm:text-xl md:text-2xl font-bold font-mono bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary  tracking-wider">
                SocialTalk
              </span>
            </Link>
          </div>
